          ...
          {!submitted ? (
                        ...
                        <div className="space-y-2">
                          ...
                          <Select>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="outra">Outro tipo</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          Estas informações são essenciais para a investigação.
                        </p>
                      </div>
            ...
            <Card>
              <CardHeader className="bg-green-50">
                ...
                <CardDescription>
                  Sua denúncia foi registrada e será analisada pelas autoridades
                  competentes.
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <div className="space-y-4">
                  <p>
                    Obrigado por contribuir para o combate à violência contra a
                    mulher. Sua denúncia é um passo importante para a proteção
                  ...
                  <p>
                    ...
                    denúncia. Caso tenha optado por se identificar, você poderá
                    ser contatada para fornecer informações adicionais.
                  </p>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2 text-sm text-muted-foreground">
                  <li>
                    ...
                    situação de perigo imediato, priorize sua segurança e ligue
                    para o 190.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    possível na sua denúncia, como data, hora, local e descrição
                    do ocorrido.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Rede de apoio:</strong> Busque apoio de familiares,
                    amigos ou serviços especializados durante todo o processo.
                  </li>
                </ul>
              </div>
