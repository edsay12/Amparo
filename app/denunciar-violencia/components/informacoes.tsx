              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Central de Atendimento à Mulher, funciona 24h por dia, todos
                    os dias.
                  </p>
                </div>
              </div>
        ...
        <Card>
          ...
          <CardContent className="pt-6">
            <div className="space-y-4 text-sm text-muted-foreground">
              <p>
                <strong>Navegação segura:</strong> Se você está em uma situação
                de risco, considere usar o modo anônimo do navegador e limpar
                seu histórico após usar este site.
              </p>
              <p>
                <strong>Botão de saída rápida:</strong> Use o botão vermelho no
                canto superior direito para sair rapidamente desta página caso
                alguém se aproxime.
              </p>
              <p>
                <strong>Privacidade:</strong> Suas informações são protegidas e
