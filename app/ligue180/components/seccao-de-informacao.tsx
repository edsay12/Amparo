                ...
                <CardContent className="space-y-6">
                  <div className="space-y-6">
                    <p>
                      ...
                      sobre a violência contra a mulher no Brasil. As
                      estatísticas geradas a partir dos atendimentos ajudam a
                      compreender o fenômeno e a orientar políticas públicas
                      mais eficazes.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
                      <motion.div
                        ...
                        whileTap={{ scale: 1 }}
                      >
                        <Card className="bg-gradient-to-br from-purple-50 to-white min-h-[100%]">
                          <CardContent className="pt-6">
                            <div className="flex flex-col items-center text-center">
                              <div className="bg-purple-100 p-3 rounded-full mb-4">
                              ...
                              <p className="text-sm text-muted-foreground">
                                Atendimentos realizados anualmente pelo Ligue
                                180
                              </p>
                            </div>
                          </CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
                      ...
                      <div className="bg-purple-50 p-6 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          O serviço facilita o acesso das mulheres à justiça e
                          aos serviços de proteção, especialmente para aquelas
                          que vivem em regiões remotas ou com poucos recursos.
                        </p>
                      </div>
                    </div>
